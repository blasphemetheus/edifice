...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    HANDLER_SYMBOL(fused_mingru_scan_backward), fused_mingru_scan_backward_ffi_impl,
    ffi::Ffi::Bind()
...
XLA_FFI_REGISTER_HANDLER(XLA_FFI_GetApi(),
    "exla_fused_mingru_scan_backward_" PRECISION_SUFFIX, "CUDA", HANDLER_SYMBOL(fused_mingru_scan_backward));
